import type { OptionsFiles, OptionsOverrides, OptionsStylistic, OptionsTypeScriptParserOptions, OptionsTypeScriptWithTypes, TypedFlatConfigItem } from '../types'

import { GLOB_ASTRO_TS, GLOB_MARKDOWN, GLOB_TS, GLOB_TSX, GLOB_VUE } from '../globs'
import { StylisticConfigDefaults } from './stylistic'

export async function mutoe(
  options: OptionsOverrides & OptionsStylistic & OptionsFiles & OptionsTypeScriptWithTypes & OptionsTypeScriptParserOptions & {
    typescript?: boolean
    vue?: boolean
  } = {},
): Promise<TypedFlatConfigItem[]> {
  const {
    files: vueFiles = [GLOB_VUE],
    stylistic,
    typescript,
    vue,
  } = options
